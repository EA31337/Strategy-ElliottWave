...
struct Stg_ElliottWave_EURUSD_M15_Params : Stg_ElliottWave_Params {
  Stg_ElliottWave_EURUSD_M15_Params() {
    symbol = "EURUSD";
    tf = PERIOD_M15;
    ...
    ElliottWave_SignalBaseMethod = -63;
    ElliottWave_SignalOpenMethod1 = 389;
