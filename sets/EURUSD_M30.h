...
struct Stg_ElliottWave_EURUSD_M30_Params : Stg_ElliottWave_Params {
  Stg_ElliottWave_EURUSD_M30_Params() {
    symbol = "EURUSD";
    tf = PERIOD_M30;
    ...
    ElliottWave_SignalOpenMethod1 = 195;
